...
/**
 * Home: what you can reach, and what needs you.
 *
 ...
 *
 * This absorbed the Workspaces tab, which listed the same rows with fewer
 * facts: two pages showing one list is a click spent to learn less. Creating
 * and removing a workspace happen here, beside the list they change.
 *
...
export default function AdminHomePage() {
  ...
  const open = async (id: string) => {
    ...
    // says "enter workspace" and leaves you where you were is a door painted
    // on a wall.
              ...
              <ul className="divide-y divide-[rgb(var(--border-line))]">
                {rows.map((workspace) => (
                  <li key={workspace.id}
                    ...
                    <Button size="xs" variant="secondary" onClick={() => open(workspace.id)}>
