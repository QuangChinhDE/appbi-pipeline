...
ACCOUNT = BaseConnector(
    app="account",
    title="Base Account",
    summary="People and organisational units. The directory every other Base application refers to.",
    summary_vi="Người dùng và đơn vị tổ chức. Danh bạ mà mọi ứng dụng Base khác tham chiếu tới.",
...
WORKFLOW = BaseConnector(
    app="workflow",
    title="Base Workflow",
    summary="Workflows, their stages, and every job running through them.",
    summary_vi="Quy trình, các giai đoạn, và mọi công việc đang chạy trong đó.",
...
REQUEST = BaseConnector(
    app="request",
    title="Base Request",
    summary="Requests staff submit, and the groups that receive them.",
    summary_vi="Đề xuất nhân viên gửi lên, và các nhóm tiếp nhận.",
...
TIMEOFF = BaseConnector(
    app="timeoff",
    title="Base Timeoff",
    summary="Time-off requests and the policy groups they fall under.",
    summary_vi="Đơn nghỉ phép và nhóm chính sách áp dụng.",
