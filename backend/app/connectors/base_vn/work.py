...
WEWORK = BaseConnector(
    app="wework",
    title="Base WeWork",
    summary="Projects, tasks, and the structures around them.",
    summary_vi="Dự án, công việc, và các cấu trúc quanh chúng.",
...
SERVICE = BaseConnector(
    app="service",
    title="Base Service",
    summary="Service desks, their handling stages, and every ticket raised against them.",
    summary_vi="Các hàng dịch vụ, giai đoạn xử lý, và toàn bộ ticket gửi tới.",
...
PAYROLL = BaseConnector(
    app="payroll",
    title="Base Payroll",
    summary="Payroll cycles, the payrolls inside each, and one pay record per employee.",
    summary_vi="Kỳ lương, các bảng lương trong kỳ, và bản ghi lương từng nhân viên.",
