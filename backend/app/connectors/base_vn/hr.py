...
HRM = BaseConnector(
    app="hrm",
    title="Base HRM",
    summary="Staff and everything the HR system records about them: contracts, insurance, positions, awards, career history, pay.",
    summary_vi="Nhân sự và mọi thứ hệ thống HR ghi nhận: hợp đồng, bảo hiểm, vị trí, khen thưởng, quá trình công tác, lương.",
...
HIRING = BaseConnector(
    app="hiring",
    title="Base E-Hiring",
    summary="Job openings, candidates, and the interview process.",
    summary_vi="Vị trí tuyển dụng, ứng viên, và quá trình phỏng vấn.",
